        ...
        <div style={css({ padding: "10px 16px 16px" })}>
          <div style={css({ display: "flex", alignItems: "center", gap: 10 })}>
            <div style={css({
              ...
              height: 32,
              borderRadius: 8,
              background: "linear-gradient(135deg, color-mix(in oklch, var(--c-accent) 75%, white) 0%, var(--c-accent) 100%)",
              display: "grid",
              placeItems: "center",
              boxShadow: "0 4px 12px -2px color-mix(in oklch, var(--c-accent) 60%, transparent)",
            })}>
        ...
        <div style={css({ padding: "4px 8px", display: "flex", flexDirection: "column", gap: 2 })}>
          {#each steps as s, i (s.id)}
            <div style={css({
              ...
              padding: "7px 10px",
              borderRadius: 6,
              background: step === i ? "var(--c-accent)" : "transparent",
        ...
        <div style={css({ flex: 1, padding: "10px 48px 0", overflow: "auto" })}>
          ...
          {#if step === 0}
            ...
            <div style={css({ marginTop: 32, display: "flex", gap: 16, alignItems: "stretch" })}>
              ...
              <div style={css({ display: "grid", placeItems: "center", padding: "0 4px", color: "var(--c-accent)" })}>
              ...
              <div class="card" style={css({
                ...
                background: "color-mix(in oklch, var(--c-accent) 12%, var(--card-bg))",
                borderColor: "color-mix(in oklch, var(--c-accent) 30%, var(--card-border))",
              })}>
                <span style={css({ fontSize: 11, color: "var(--c-accent)", letterSpacing: 0.4, textTransform: "uppercase", fontWeight: 600 })}>Meeting hears</span>
              ...
              <div style={css({ marginTop: 14, paddingTop: 14, borderTop: "0.5px solid var(--hairline)",
                ...
                <div style={css({ display: "flex", gap: 9, alignItems: "flex-start", fontSize: 12, color: "var(--txt-2)", lineHeight: 1.45 })}>
                  ...
                  <span>Don't have a key? <a href="https://platform.openai.com/api-keys"
                        style={css({ color: "var(--c-accent)", textDecoration: "underline", textUnderlineOffset: 2, cursor: "pointer" })}
          ...
          {:else if step === 3}
            ...
            <div class="card" style={css({ padding: 20 })}>
              <div style={css({ display: "flex", gap: 16, alignItems: "center", marginBottom: 14 })}>
                <div style={css({
                  width: 56, height: 56, borderRadius: 14,
                  background: installed ? "color-mix(in oklch, var(--c-translate) 18%, transparent)" : "color-mix(in oklch, var(--c-accent) 14%, transparent)",
                  display: "grid", placeItems: "center",
                  color: installed ? "var(--c-translate)" : "var(--c-accent)",
                })}>
                ...
                {#each store.devices.sources as source (source.id)}
                  ...
                  <div onclick={() => store.setAudioSource(source.id)}
                       ...
                       style={css({
                         ...
                         borderRadius: 7,
                         cursor: "pointer",
                         background: selected ? "color-mix(in oklch, var(--c-accent) 14%, transparent)" : "transparent",
                         border: selected ? "1px solid color-mix(in oklch, var(--c-accent) 35%, transparent)" : "1px solid transparent",
                       })}>
                    <span style={css({
                      width: 18, height: 18, borderRadius: "50%",
                      border: `1.5px solid ${selected ? "var(--c-accent)" : "var(--txt-3)"}`,
                      display: "grid", placeItems: "center",
                    })}>
            ...
            <div class="card" style={css({ padding: 18, display: "flex", flexDirection: "column", gap: 14 })}>
              <div style={css({ display: "flex", alignItems: "center", gap: 12 })}>
                <div style={css({
                  ...
                  color: testStage === "done" || testStage === "heard" ? "var(--c-translate)" : "var(--c-accent)",
                  display: "grid", placeItems: "center",
                })}>
                ...
                <div style={css({ width: 140 })}>
                  <VUStrip
                    ...
                    color={testStage === "done" ? "var(--c-translate)" : "var(--c-accent)"}
                  />
                </div>
              </div>
              <!-- Source text -->
          ...
          {:else if step === 7}
            ...
            <div class="card" style={css({ padding: 16 })}>
              ...
              <div style={css({
                ...
                background: "color-mix(in oklch, var(--c-accent) 8%, var(--card-bg))",
                ...
                <div style={css({ display: "flex", flexDirection: "column", gap: 4 })}>
                  ...
                  <div style={css({
                    ...
                    color: "var(--txt-1)",
                    border: "0.5px solid color-mix(in oklch, var(--c-accent) 35%, transparent)",
                    fontSize: 12.5,
                  })}>
                    <span style={css({
                      width: 14, height: 14, borderRadius: 3,
