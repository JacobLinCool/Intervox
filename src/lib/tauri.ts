...
export interface AppStatus {
  mode: BackendMode; health: Health;
...
export interface Config {
  ...
  translation: { source_language: string; target_language: string; quality_mode: Quality };
  ...
  privacy: { save_transcript_history: boolean; send_diagnostics: boolean };
...
export const cmd = {
  ...
  setSourceLanguage: (language: string) => invoke("set_source_language", { language }),
